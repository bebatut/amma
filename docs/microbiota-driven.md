...
Extract samples | [<i class="far fa-file-image"></i>]({{ dp }}/1-extract_samples.html) | [<i class="fab fa-github"></i>]({{ site.github.repository_url }}/tree/master/src/1-extract_samples.ipynb) |
Run Differential expression analysis | [<i class="far fa-file-image"></i>]({{ dp }}/2-run_dge_analysis.html) | [<i class="fab fa-github"></i>]({{ site.github.repository_url }}/tree/master/src/{{ dp }}/2-run_dge_analysis.ipynb) |
Previsualize the normalized count data | [<i class="far fa-file-image"></i>]({{ dp }}/3-previsualize_data.html) | [<i class="fab fa-github"></i>]({{ site.github.repository_url }}/tree/master/src/{{ dp }}/3-previsualize_data.ipynb) | [<i class="fas fa-file"></i>]({{ site.github.repository_url }}/tree/master/results/dge/{{ dp }}/3-previsualize_data)
...
Analysis | Report | Sources | Data & Results
--- | --- | --- | ---
Comparison between the microbiota (GF vs SPF) for the ages | [<i class="far fa-file-image"></i>]({{ dp }}/4-analyze_microbiota_effect_given_ages.html) | [<i class="fab fa-github"></i>]({{ site.github.repository_url }}/tree/master/src/{{ dp }}/4-analyze_microbiota_effect_given_ages.ipynb) | [<i class="fas fa-file"></i>]({{ site.github.repository_url }}/tree/master/results/dge/{{ dp }}/4-analyze_microbiota_effect_given_ages)
Comparison between the ages (Old vs Young) for the microbiota | [<i class="far fa-file-image"></i>]({{ dp }}/5-analyze_age_effect_given_microbiota.html) | [<i class="fab fa-github"></i>]({{ site.github.repository_url }}/tree/master/src/{{ dp }}/5-analyze_age_effect_given_microbiota.ipynb) | [<i class="fas fa-file"></i>]({{ site.github.repository_url }}/tree/master/results/dge/{{ dp }}/5-analyze_age_effect_given_microbiota)
