...
Analysis | Report | Sources | Data & Results
--- | --- | --- | ---
Comparison between the sexes (Male vs Female) for the ages | [<i class="far fa-file-image"></i>]({{ dp }}/4-analyze_sex_effect_given_ages.html) | [<i class="fab fa-github"></i>]({{ site.github.repository_url }}/tree/master/src/{{ dp }}/4-analyze_sex_effect_given_ages.ipynb) | [<i class="fas fa-file"></i>]({{ site.github.repository_url }}/tree/master/results/dge/{{ dp }}/4-analyze_sex_effect_given_ages)
Comparison between the ages (Young, Middle-aged, Old) for the sexes | [<i class="far fa-file-image"></i>]({{ dp }}/4-analyze_age_effect_given_sex.html) | [<i class="fab fa-github"></i>]({{ site.github.repository_url }}/tree/master/src/{{ dp }}/4-analyze_age_effect_given_sex.ipynb) | [<i class="fas fa-file"></i>]({{ site.github.repository_url }}/tree/master/results/dge/{{ dp }}/4-analyze_age_effect_given_sex)
